...
<thead>
                ...
                while ($row = mysqli_fetch_array($foto)) { ?>
                            <tr>
                                ...
                                : 'Aktif'; ?></td>
                                <td>
                                <a style="padding: 8px 3px; background-color: #009b27; color: #fff;" href="edit-image.php?id=<?php echo $row['image_id']?>">Edit</a> ||
                            
                                <a href="proses-hapus.php?idp=<?php echo
                                $row['image_id'] ?>" onclick="return confirm('Yakin Ingin Hapus ?')" class="btn">Hapus</a>
                                </td>
                            </tr>
                        <?php }
                         }else { ?>
