<?php
    error_reporting(0);
    include 'db.php';
    $kontak = mysqli_query($conn, "SELECT admin_telp, admin_email, admin_addres
...
<body>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                <div class="col-2">
                    <img src="foto/<?php echo $p->image ?>" width="100%" alt="">
                </div>
                <div class="col-2">
    ...
    <script>
    // JavaScript untuk membuat footer bergerak
    function moveFooter() {
    ...
    // Panggil fungsi moveFooter saat halaman di-scroll
